...
class Process(multiprocessing.Process):
    ...
    def run(self):
        ...
        #     writer.writerow(row)
        #     f.close()
        cmd1 = 'wsk -i action create ' + self.fun + str(self.id) +' --docker zeast1993/python3action:matrixpy'+ ' ' + self.fun_script
        cmd2 = 'wsk -i action invoke ' + self.fun + str(self.id) + ' --result'
        os.system(cmd1)
        os.system(cmd2)
        print(str(t))
